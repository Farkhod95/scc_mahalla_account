...
class BazarCameraSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BazarCamera
        fields = ('id', 'object_name', 'type', 'coordinate_x', 'coordinate_y', 'url', 'icon', 'login', 'parol', 'region', 'district', 'mahalla')
...
class BazarCameraListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BazarCamera
        fields = ('id', 'object_name', 'type', 'coordinate_x', 'coordinate_y', 'url', 'icon', 'login', 'parol', 'region', 'region_detail', 'district', 'district_detail', 'mahalla', 'mahalla_detail')