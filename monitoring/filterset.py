...
class ShopTenantFilter(django_filters.FilterSet):
    ...
    cash_register_number_vat = django_filters.CharFilter(field_name='cash_register_number_vat', lookup_expr='icontains')
    cash_register_number_turnover = django_filters.CharFilter(field_name='cash_register_number_turnover', lookup_expr='icontains')
    ...
    monthly_checks_count_vat_from = django_filters.NumberFilter(field_name='monthly_checks_count_vat', lookup_expr='gte')
    monthly_checks_count_vat_to = django_filters.NumberFilter(field_name='monthly_checks_count_vat', lookup_expr='lte')
    monthly_checks_count_turnover_from = django_filters.NumberFilter(field_name='monthly_checks_count_turnover', lookup_expr='gte')
    monthly_checks_count_turnover_to = django_filters.NumberFilter(field_name='monthly_checks_count_turnover', lookup_expr='lte')
    daily_checks_count_vat_from = django_filters.NumberFilter(field_name='daily_checks_count_vat', lookup_expr='gte')
    daily_checks_count_vat_to = django_filters.NumberFilter(field_name='daily_checks_count_vat', lookup_expr='lte')
    daily_checks_count_turnover_from = django_filters.NumberFilter(field_name='daily_checks_count_turnover', lookup_expr='gte')
    daily_checks_count_turnover_to = django_filters.NumberFilter(field_name='daily_checks_count_turnover', lookup_expr='lte')
    ...
    ytd_okkm_vat_from = django_filters.NumberFilter(field_name='ytd_okkm_vat', lookup_expr='gte')
    ytd_okkm_vat_to = django_filters.NumberFilter(field_name='ytd_okkm_vat', lookup_expr='lte')
    ytd_okkm_turnover_from = django_filters.NumberFilter(field_name='ytd_okkm_turnover', lookup_expr='gte')
    ytd_okkm_turnover_to = django_filters.NumberFilter(field_name='ytd_okkm_turnover', lookup_expr='lte')
    mtd_okkm_vat_from = django_filters.NumberFilter(field_name='mtd_okkm_vat', lookup_expr='gte')
    mtd_okkm_vat_to = django_filters.NumberFilter(field_name='mtd_okkm_vat', lookup_expr='lte')
    mtd_okkm_turnover_from = django_filters.NumberFilter(field_name='mtd_okkm_turnover', lookup_expr='gte')
    mtd_okkm_turnover_to = django_filters.NumberFilter(field_name='mtd_okkm_turnover', lookup_expr='lte')
    dtd_okkm_vat_from = django_filters.NumberFilter(field_name='dtd_okkm_vat', lookup_expr='gte')
    dtd_okkm_vat_to = django_filters.NumberFilter(field_name='dtd_okkm_vat', lookup_expr='lte')
    dtd_okkm_turnover_from = django_filters.NumberFilter(field_name='dtd_okkm_turnover', lookup_expr='gte')
    dtd_okkm_turnover_to = django_filters.NumberFilter(field_name='dtd_okkm_turnover', lookup_expr='lte')
    ...
    class Meta:
        ...
        fields = ('shop', 'business_type', 'tax_type', 'activity_status', 'fire_safety_level', 'has_fire_alarm',
                  ...
                  'cash_register_number_vat', 'cash_register_number_turnover', 'employees_count',
...
class MFYCitizenFilter(django_filters.FilterSet):
    full_name = django_filters.CharFilter(field_name='full_name', lookup_expr='icontains')
