...
class EmployeeListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Employee
        fields = ('id', 'full_name', 'date_of_birthday', 'gender', 'phone_number', 'organization', 'organization_detail',
...
class ObjectCategorySerializer(LocaleSerializer):
    class Meta:
        ...
        fields = ('id', 'key', 'name', 'name_uz', 'name_ru', 'name_en', 'icon', 'color', 'icon_color')
        extra_kwargs = {
...
class ObjectCategoryForDashboardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ObjectCategory
        fields = ("id", 'key', "name_uz", "name_ru", "name_en", 'icon', "objects_count", 'color', 'icon_color')
